...
function AnalisisManagement() {
  ...
  return (
    <div className="bg-white p-4 rounded shadow-md mx-4">
      <h2 className="text-xl font-bold mb-4">Manajemen Data Analisis</h2>
          ...
          {!!dataAnalisis &&
            dataAnalisis.map((analisis) => (
              <tr key={analisis.id}>
                ...
                <td className="p-4 text-sm text-slate-800">{analisis.Long}</td>
